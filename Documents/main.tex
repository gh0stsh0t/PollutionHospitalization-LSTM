...
\section{Conclusions}
RNNs are a type of deep neural network that uses a state cell to act as memory to use previous inputs in a sequence. This makes it a good choice for time series data which takes into account the order of inputs
