...
Results of the accuracy of the most efficient models Lower Batch4 and Grid Search3 indicates a positive correlation between air quality and hospitalization cases. Using the data as shown in Table 3.1 and 3.2 under the months of October and November 2015, the model outputs a total number of approximately 418 and 332 cases, respectively. Although the output is off by a few cases, it more or less shows that poorer air quality levels directly results to higher hospitalization cases, with October having higher pollutant measurements compared to November. 
