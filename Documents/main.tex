...
\begin{figure}[H]
    \centering
    \subfloat[train/test loss graph]{{\includegraphics[width=5in,height=3in]{Data/optimizer.pdf}}}%
    \qquad
    \subfloat[prediction graph]{{\includegraphics[width=5in,height=3in]{Data/predictions_optimizer.pdf} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[train/test loss graph]{{\includegraphics[width=5in,height=3in]{Data/batch_size.pdf}}}%
    \qquad
    \subfloat[prediction graph]{{\includegraphics[width=5in,height=3in]{Data/predictions_batch_size.pdf} }}%
    \caption{Batch Size}%
    \label{fig:batch}%
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[train/test loss graph]{{\includegraphics[width=5in,height=3in]{Data/layer_3.pdf}}}%
    \qquad
    \subfloat[prediction graph]{{\includegraphics[width=5in,height=3in]{Data/predictions_layer_3.pdf} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[train/test loss graph]{{\includegraphics[width=5in,height=3in]{Data/grid_search.pdf}}}%
    \qquad
    \subfloat[prediction graph]{{\includegraphics[width=5in,height=3in]{Data/predictions_grid_search.pdf} }}%
    \caption{Grid Search}%
    \label{fig:grid}%
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[train/test loss graph]{{\includegraphics[width=5in,height=3in]{Data/ffdnn.pdf}}}%
    \qquad
    \subfloat[prediction graph]{{\includegraphics[width=5in,height=3in]{Data/predictions_ffdnn.pdf} }}%
